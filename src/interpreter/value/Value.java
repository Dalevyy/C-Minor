...
/**
 * A type that represents a value during the runtime execution of the {@link interpreter.Interpreter}.
 * <p><br>
 *     This class is designed to create values that will be stored on the {@link utilities.RuntimeStack}
 *     during the execution of the {@link interpreter.Interpreter}. It is mainly designed to help reduce
...
public class Value {
     ...
     *     operators in the {@link interpreter.Interpreter} to deduce
     *     whether or not two values are equal. We will return the result
     *     to the {@link interpreter.Interpreter}, so it can save the value.
     * </p>
