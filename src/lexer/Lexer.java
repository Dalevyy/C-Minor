    ...
    */
    public String getProgramInputForToken(Position start, Position end) {
        ...
        for(int i = start.line; i <= end.line; i++) {
            ...
            for(int j = startCol; j < strSize; j++)
    ...
    public void printSyntaxError(Position start) {
        System.out.println(start.line + "| " + lines.get(start.line-1));
    }
    ...
    private void consume() {
        ...
        try {
            ...
            lines.add(currLoc.end.line-1,currText);
        }
