...
/**
 * A {@link SubNode} type representing the condition to execute a {@link CaseStmt}.
 * <p>
 *     Currently, labels are only used within a {@link ChoiceStmt} in order to keep
 *     track of which {@link CaseStmt} needs to be executed. A label will either
...
public class Label extends AST {
    ...
    /**
     * Either a single constant or the left constant in a {@link CaseStmt}.
     */
    private Literal leftConstant;

    /**
     * The right constant in a {@link CaseStmt} with a range label.
     */
