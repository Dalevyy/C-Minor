...
/**
 * An {@link AST} subtype representing a node that can be found inside a {@link ClassDecl}.
 * <p>
...
public abstract class ClassNode extends AST {
    ...
    /**
     * Checks if the current AST node is a {@link cminor.ast.classbody.ClassBody}.
     * @return {@code True} if the node is a {@link cminor.ast.classbody.ClassBody}, {@code False} otherwise.
     */
     ...
     * @return {@code True} if the node is a {@link FieldDecl}, {@code False} otherwise.
     */
    public boolean isFieldDecl() { return false; }

    /**
     * Checks if the current AST node is an {@link cminor.ast.classbody.InitDecl}.
     * @return {@code True} if the node is an {@link cminor.ast.classbody.InitDecl}, {@code False} otherwise.
     */
    public boolean isInitDecl() { return false; }

    /**
     * Checks if the current AST node is a {@link MethodDecl}.
     * @return {@code True} if the node is a {@link MethodDecl}, {@code False} otherwise.
     */
